...
# --- 7. Feature Selection ---
    ...
    def get_stats_html(gen_text, current_features, orig_acc_pct, current_acc, speed_gain):
        ...
        current_color = "#2ecc71" if current_acc > orig_acc_pct else "#e74c3c"
        html += f"<div style='font-size: 24px; font-weight: 900;'><span>{orig_acc_pct:.1f}%</span> ➔ <span style='color: {current_color};'>{current_acc:.1f}%</span></div></div>"
